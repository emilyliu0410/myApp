...
class UTWatermark{	
     ...
     */
	 ...
	 var $margin;
    function UTWatermark($img_file,$position='RightBottom',$pct=99)
    {
		$size=explode('/', $img_file);
		if(end($size)=='_watermark_600x400.png') {
			$this->margin=15;
		}else if(end($size)=='_watermark_1024x683.png'){
			$this->margin=25;
		}
