...
class UTImage {
	...
	*/
	function resize($srcImg,$dstImg,$dstW,$dstH,$forceDst=false,$quality=99){
	...
	//resize image to dstW & dstH and keep the W&H proportion.
	function ceterResize($srcImg,$dstImg,$dstW,$dstH,$forceDst=false,$quality=99){
	...
	function watermark($file,$watermark_type=false, $quality=1,$backup_thread=false,$watermarkFile=false){
		...
		$wm = new UTWatermark($watermarkFile,$watermark_type,$quality);
		//debug($wm);
