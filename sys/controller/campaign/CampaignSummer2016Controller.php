...
require_once('summer2016/campaignAnswer.class.php');
class CampaignSummer2016Controller extends UController
{
			...
			if($valid->error){
				...
				if($_POST['form_page']=='5'){
					...
					if (isset($_COOKIE['campaign_summer2016'])) {
						...
						uSetCookie('campaign_summer2016', null, -1, '/');
						return true;
					}
				}else{
					if(isset($_POST['answer_1'])) uSetCookie('campaign_summer2016[answer_1]',$_POST['answer_1'],0,"/");
					if(isset($_POST['answer_2'])) uSetCookie('campaign_summer2016[answer_2]',$_POST['answer_2'],0,"/");
					if(isset($_POST['agree'])) uSetCookie('campaign_summer2016[agree]',$_POST['agree'],0,"/");
	...
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/summer2016');
		...
		switch($_GET['p']){
			...
			case 5:
			case 6:
				$canonicalUrl = $this->createUrl('/campaign/summer2016',array('p'=>$_GET['p']));
