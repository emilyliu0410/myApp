...
class CampaignAnswer{
	const CAMPAIGN_ID=148;
	// const CAMPAIGN_ANS_TABLE='tbl_campaign_ans';
	const CAMPAIGN_ANS_TABLE='tbl_campaign_ans';
	const CAMPAIGN_USER_TABLE='tbl_campaign_users';
	function validPost(){
	...
	function store(){
		...
		$sql="INSERT INTO ".self::CAMPAIGN_ANS_TABLE."
			(user_id,campaign_id,name,answer_1,answer_2,answer_3,answer_4,answer_5,answer_6,fb_name,email,phone,hkid,create_date)
			VALUES ('".$user_id."','".self::CAMPAIGN_ID."','".safe_input($_POST['name'])."','".safe_input($_POST['q1'])."','".safe_input($_POST['q2'])."','".safe_input($_POST['q3'])."','".safe_input($_POST['q4'])."','".safe_input($_POST['q5'])."','".safe_input($_POST['q6'])."','".$_POST['fbname']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['hkid']."',NOW())";
		$rid=uDb()->query($sql);
