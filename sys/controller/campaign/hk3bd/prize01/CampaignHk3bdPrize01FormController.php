...
class CampaignHk3bdPrize01FormController extends UController
{
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/hk3bd/'.CAMPAIGN_PERIOD.'/form');
		$this->view='/campaign/hk3bd/questions/'.CAMPAIGN_PERIOD.'/form';
