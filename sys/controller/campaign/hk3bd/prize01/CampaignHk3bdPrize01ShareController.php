...
class CampaignHk3bdPrize01ShareController extends UController
{
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/hk3bd/'.CAMPAIGN_PERIOD.'/share');
		$this->view='/campaign/hk3bd/questions/'.CAMPAIGN_PERIOD.'/share';
		...
		array_push($this->cssFiles, $imgDir.'css/newStyle.css?v=1');
