...
class CampaignSma2017IntroductionController extends UController
{
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/sma2017/introduction');
		$this->view='/campaign/sma2017/introduction';
		...
		$this->pageTitle = CAMPAIGN_META_TITLE.' - 活動簡介';
