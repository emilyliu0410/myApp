...
class CampaignSma2017ComingsoonController extends UController
{
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/sma2017/comingsoon');
		$this->view='/campaign/sma2017/comingsoon';
