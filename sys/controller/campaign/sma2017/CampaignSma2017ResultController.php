...
class CampaignSma2017ResultController extends UController
{
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/sma2017/result');
		$this->view='/campaign/sma2017/result';
		...
		$this->pageTitle = CAMPAIGN_META_TITLE.' - 投票結果';
