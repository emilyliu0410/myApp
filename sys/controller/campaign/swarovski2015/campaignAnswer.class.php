...
//	const tid = 185;
	...
	function validPost(){
		...
		// elseif($post['contact_address'] == '' && $post['form_page'] == '5'){
			// $rt->error='請輸入你的郵寄地址';
		// }
		// elseif($post['answer_1'] == '' && $post['form_page'] == '5'){
			// $rt->error='請問片中女主角的手鐲戴在哪一隻手上？';
		// }
		// elseif($post['answer_2'] == '' && $post['form_page'] == '5'){
			// $rt->error='片中的SWAROVSKI裝飾主題是？';
		// }
		// elseif($post['answer_3'] == '' && $post['form_page'] == '5'){
			// $rt->error='請分享您心目中的聖誕 Perfect Gift。';
		// }elseif($post['answer_4'] == '' && $post['form_page'] == '5'){
			// $rt->error='填寫閣下於 App Store / Google Play / Samsung App Store 內之顯示名稱';
		// }
