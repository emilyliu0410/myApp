...
//	const tid = 185;
	...
	function validPost(){
		...
		//index3
		elseif($post['answer_1'] == '' && ($post['form_page'] == '3' || $post['form_page'] == '5')){
				$rt->error='請選擇您最經常瀏覽港生活的項目';
		} 
		 elseif($post['answer_2'] == ''  && ($post['form_page'] == '3' || $post['form_page'] == '5')){
			$rt->error='請分享香港幾間彈床樂園之中，點解您最想去BOUNCE？';
		}
		//index4
		elseif($post['agree'] == ''  && ($post['form_page'] == '4' || $post['form_page'] == '5')){
