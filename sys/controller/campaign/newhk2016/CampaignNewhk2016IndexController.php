...
class CampaignNewhk2016IndexController extends UController
{
			...
			if($valid->error){
				...
				if($_POST['form_page']=='5'){
					...
					if (isset($_COOKIE['campaign_newhk2016'])) {
						...
						setcookie('campaign_newhk2016', null, -1, '/');
						// setcookie('UHK_campaign_newhk2016[answer_2]', time()-3600, -1, '/');
						return true;
					}
				}else{
					if(isset($_POST['answer_1'])) uSetCookie('campaign_newhk2016[answer_1]',$_POST['answer_1']);
					if(isset($_POST['answer_2'])) uSetCookie('campaign_newhk2016[answer_2]',$_POST['answer_2']);
					if(isset($_POST['agree'])) uSetCookie('campaign_newhk2016[agree]',$_POST['agree']);
	...
	function actionIndex(){
		...
		$subtitle = null;
		$canonicalUrl = $this->createUrl('/campaign/newhk2016/index');
		switch($_GET['p']){
			case 2:
			case 3:
			case 4:
			...
			case 6:
				...
				$canonicalUrl = $this->createUrl('/campaign/newhk2016/index',array('p'=>$_GET['p']));
